...
contract  LotteryRandom is VRFConsumerBaseV2, Ownable {
   ...
   * @param initialOwner address of initialOwner
   ...
   */
    constructor(address initialOwner, address vrfCoordinator, address linkToken,
    bytes32 vrfKeyHash, uint256 vrfFee)
    onlyOwner(initialOwner)
   ...
   */
    function requestRandomness(bytes32 requestId, uint256 randomness) internal virtual override  {

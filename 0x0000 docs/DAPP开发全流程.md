...
- [DAPP 开发全流程（详细说明）](#dapp-开发全流程详细说明)
  ...
  - [三、前端开发：用户交互与区块链连接](#三前端开发用户交互与区块链连接)
    - [3.1 前端初始化和框架搭建](#31-前端初始化和框架搭建)
    - [3.2 钱包连接功能实现](#32-钱包连接功能实现)
    - [3.3 区块链数据查询与展示](#33-区块链数据查询与展示)
    - [3.4 合约写操作（触发交易，消耗 Gas）](#34-合约写操作触发交易消耗-gas)
    - [3.5 前端 UI 优化与用户体验](#35-前端-ui-优化与用户体验)
